...
/***/ (function(module, exports, __webpack_require__) {
  ...
  AFRAME.registerComponent('animation', {
    schema: {
      ...
      isChangeSceneAnim: {default: false}
    },
    ...
    init: function () {
      ...
      this.updateConfigForChangeSceneAnimation = this.updateConfigForChangeSceneAnimation.bind(this);
     ...
     * SMIS
     */
    updateConfigForChangeSceneAnimation: function () {
      var config = this.config;
      var data = this.data;
      var el = this.el;
      var from;
      ...
      if (this.waitComponentInitRawProperty(this.updateConfigForChangeSceneAnimation)) {
        return;
      }
      ...
      config.update = (function () {
        ...
        return function (anim) {
          ...
          const mesh360 = el.getObject3D('mesh');
          if(mesh360){
            const material = mesh360.material;
            if(Array.isArray(material)){
              // image360
              for (let i = 0; i < material.length; i += 1) {
                if (material[i]) {
                  material[i].opacity = value;
                }
              }
            }else{
              // video360
            ...
            // data-opacity is used to set new texture opacity.
    ...
    updateConfig: function () {
      ...
      // SMIS
      if(this.data.isChangeSceneAnim){
        this.updateConfigForChangeSceneAnimation();
      }else if (isRawProperty(this.data) && this.data.type === TYPE_COLOR) {
